  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        >
          Nossa missão é castrar e educar — as únicas formas sustentáveis de
          reduzir o abandono animal em Arraial d&apos;Ajuda. Quando o poder público
          não chega e a situação é extrema, também resgatamos.
        </p>
